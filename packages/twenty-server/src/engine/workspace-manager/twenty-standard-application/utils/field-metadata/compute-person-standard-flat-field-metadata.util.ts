...
>): Record<AllStandardObjectFieldName<'person'>, FlatFieldMetadata> => ({
  ...
  // Salesforce lead import fields (Perfect Ventures) — labels match CSV headers
  country: createStandardFieldFlatMetadata({
    ...
    context: {
      fieldName: 'country',
      type: FieldMetadataType.TEXT,
      label: i18nLabel(msg`Country`),
      description: i18nLabel(msg`Country from Salesforce lead import`),
      icon: 'IconMap',
      isNullable: true,
    },
    standardObjectMetadataRelatedEntityIds,
  ...
  leadId: createStandardFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      fieldName: 'leadId',
      type: FieldMetadataType.TEXT,
      label: i18nLabel(msg`Lead ID`),
      description: i18nLabel(msg`Salesforce Lead ID`),
      icon: 'IconId',
      isNullable: true,
      isUnique: true,
    },
  ...
  lead18Id: createStandardFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      fieldName: 'lead18Id',
      type: FieldMetadataType.TEXT,
      label: i18nLabel(msg`Lead 18 ID`),
      description: i18nLabel(msg`Salesforce 18-character Lead ID`),
      icon: 'IconId',
      isNullable: true,
      isUnique: true,
    },
  ...
  leadSource: createStandardFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      fieldName: 'leadSource',
      type: FieldMetadataType.TEXT,
      label: i18nLabel(msg`Lead Source`),
      description: i18nLabel(msg`Salesforce Lead Source`),
      icon: 'IconMapPin',
      isNullable: true,
    },
    standardObjectMetadataRelatedEntityIds,
  ...
  swFitScore: createStandardFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      fieldName: 'swFitScore',
      type: FieldMetadataType.TEXT,
      label: i18nLabel(msg`SW Fit Score`),
      description: i18nLabel(msg`SW Fit Score from Salesforce`),
      icon: 'IconChartBar',
      isNullable: true,
    },
    standardObjectMetadataRelatedEntityIds,
  ...
  street: createStandardFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      fieldName: 'street',
      type: FieldMetadataType.TEXT,
      label: i18nLabel(msg`Street`),
      description: i18nLabel(msg`Street from Salesforce lead import`),
      icon: 'IconRoad',
      isNullable: true,
    },
    standardObjectMetadataRelatedEntityIds,
  ...
  rating: createStandardFieldFlatMetadata({
    ...
    context: {
      ...
      description: i18nLabel(msg`Salesforce Rating`),
      icon: 'IconStar',
      isNullable: true,
    },
    standardObjectMetadataRelatedEntityIds,
  ...
  leadOwner: createStandardFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      fieldName: 'leadOwner',
      type: FieldMetadataType.TEXT,
      label: i18nLabel(msg`Lead Owner`),
      description: i18nLabel(msg`Salesforce Lead Owner`),
      icon: 'IconUser',
      isNullable: true,
    },
    standardObjectMetadataRelatedEntityIds,
  ...
  ownerDivision: createStandardFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      fieldName: 'ownerDivision',
      type: FieldMetadataType.TEXT,
      label: i18nLabel(msg`Owner Division`),
      description: i18nLabel(msg`Owner Division from Salesforce`),
      icon: 'IconBuilding',
      isNullable: true,
    },
    standardObjectMetadataRelatedEntityIds,
  ...
  roeSubDivision: createStandardFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      fieldName: 'roeSubDivision',
      type: FieldMetadataType.TEXT,
      label: i18nLabel(msg`ROE Sub Division`),
      description: i18nLabel(msg`ROE Sub Division from Salesforce`),
      icon: 'IconHierarchy2',
      isNullable: true,
    },
    standardObjectMetadataRelatedEntityIds,
  ...
  createDate: createStandardFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      fieldName: 'createDate',
      type: FieldMetadataType.DATE_TIME,
      label: i18nLabel(msg`Create Date`),
      description: i18nLabel(
        msg`Salesforce Create Date (imported; separate from system Creation date)`,
      ),
  ...
  lastActivityDate: createStandardFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      fieldName: 'lastActivityDate',
      type: FieldMetadataType.DATE,
      label: i18nLabel(msg`LastActivityDate`),
      description: i18nLabel(msg`Salesforce LastActivityDate`),
  ...
  emailAddressDomainTypeSfdc: createStandardFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      fieldName: 'emailAddressDomainTypeSfdc',
      type: FieldMetadataType.TEXT,
      label: i18nLabel(msg`Email address domain type SFDC`),
      description: i18nLabel(msg`Email address domain type from Salesforce`),
      icon: 'IconMail',
      isNullable: true,
    },
    standardObjectMetadataRelatedEntityIds,
