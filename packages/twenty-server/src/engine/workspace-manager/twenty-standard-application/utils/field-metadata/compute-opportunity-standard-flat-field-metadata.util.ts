...
>): Record<AllStandardObjectFieldName<'opportunity'>, FlatFieldMetadata> => ({
  ...
  pvStage: createStandardFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      fieldName: 'pvStage',
      type: FieldMetadataType.SELECT,
      label: i18nLabel(msg`PV Stage`),
      description: i18nLabel(msg`PV lifecycle stage for the opportunity`),
      icon: 'IconProgressCheck',
      isNullable: false,
      defaultValue: "'NEW'",
      options: [
        {
          id: '20202020-a1a1-4afd-9c39-d2063097587a',
          value: 'NEW',
          label: i18nLabel(msg`New`),
          position: 0,
          color: 'red',
        ...
        {
          id: '20202020-a1a2-4afd-9c39-d2063097587a',
          value: 'CONTACTED',
        ...
        {
          id: '20202020-a1a3-4afd-9c39-d2063097587a',
          value: 'SQS',
          label: i18nLabel(msg`SQS`),
          position: 2,
          color: 'purple',
        },
        {
          id: '20202020-a1a4-4afd-9c39-d2063097587a',
          value: 'CONVERSATION',
          label: i18nLabel(msg`Conversation`),
          position: 3,
          color: 'sky',
        },
        {
          id: '20202020-a1a5-4afd-9c39-d2063097587a',
          value: 'MEETING_SCHEDULED',
          label: i18nLabel(msg`Meeting Scheduled`),
          position: 4,
          color: 'blue',
        },
        {
          id: '20202020-a1a6-4afd-9c39-d2063097587a',
          value: 'MEETING_COMPLETED',
          label: i18nLabel(msg`Meeting Completed`),
          position: 5,
          color: 'turquoise',
        },
        {
          id: '20202020-a1a7-4afd-9c39-d2063097587a',
          value: 'SQL',
          label: i18nLabel(msg`SQL`),
          position: 6,
          color: 'yellow',
        },
        {
          id: '20202020-a1a8-4afd-9c39-d2063097587a',
          value: 'OPPORTUNITY',
        ...
        {
          id: '20202020-a1a9-4afd-9c39-d2063097587a',
          value: 'CLOSED_WON',
          label: i18nLabel(msg`Closed-Won`),
          position: 8,
          color: 'green',
        },
        {
          id: '20202020-a1aa-4afd-9c39-d2063097587a',
          value: 'LOST',
