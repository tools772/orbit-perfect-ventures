...
import { AddPersonSfdcLeadImportFieldsCommand } from 'src/database/commands/upgrade-version-command/2-23/2-23-workspace-command-1784900000000-add-person-sfdc-lead-import-fields.command';
...
@Module({
  ...
  providers: [
    ...
    AddPersonSfdcLeadImportFieldsCommand,
  ],
})
